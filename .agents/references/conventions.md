...
- Preferir `pnpm` (`pnpm-lock.yaml`). Pacotes Expo nativos: `pnpm expo install`, não `pnpm add` com versões de SDK antigo (`expo-file-system` 19.x no SDK 57 crasha o Android).
